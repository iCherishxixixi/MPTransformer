...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.UXNet3D. \
    network_backbone import UXNET as UXNET_Orig
from nnunet_mpt.training.network_training.nnUNet_variants.architectural_variants.nnUNetTrainerV2_noDeepSupervision \
