...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransFuse.TransFuse import TransFuse_S as TransFuse_S_Orig
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransFuse.TransFuseL import TransFuse_L as TransFuse_L_Orig
...
# Wrapper using SegmentationNetwork object
class TransFuse_L(TransFuse_L_Orig, SegmentationNetwork):  
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Segmentation Network Params. Needed for the nnUNet evaluation pipeline
        self.conv_op = nn.Conv2d
