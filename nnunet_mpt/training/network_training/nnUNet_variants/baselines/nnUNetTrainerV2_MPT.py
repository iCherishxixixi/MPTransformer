...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.MPT.MPTnnF import MPTnnF as MPTnnF_Orig
...
class MPTnnF(MPTnnF_Orig, SegmentationNetwork):
...
class nnUNetTrainerV2_MPTnnF_128x128x128(nnUNetTrainerV2_noDeepSupervision):
    def __init__(self, *args, **kwargs):
        super().__init__( *args, **kwargs)
...
class nnUNetTrainerV2_MPTnnF_128x128x128_Dummy(nnUNetTrainerV2_MPTnnF_128x128x128):
...
class nnUNetTrainerV2_MPTnnF_128x128x128_lr5e5(nnUNetTrainerV2_noDeepSupervision):
