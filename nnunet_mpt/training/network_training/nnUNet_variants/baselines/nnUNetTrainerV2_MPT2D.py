...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.MPT2D.vit_seg_modeling import MPT2D as MPT2D_Orig
...
class MPT2D(MPT2D_Orig, SegmentationNetwork):
...
class nnUNetTrainerV2_MPT2D(nnUNetTrainerV2_noDeepSupervision):
...
class nnUNetTrainerV2_MPT2D_Dummy(nnUNetTrainerV2_MPT2D):
