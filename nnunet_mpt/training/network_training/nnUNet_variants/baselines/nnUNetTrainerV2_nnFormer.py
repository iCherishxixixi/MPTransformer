...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.nnFormer.nnFormer_tumor import nnFormer as nnFormer_Orig
...
class nnUNetTrainerV2_nnFormer(nnUNetTrainerV2_noDeepSupervision):
...
class nnUNetTrainerV2_nnFormer_Dummy(nnUNetTrainerV2_nnFormer):
