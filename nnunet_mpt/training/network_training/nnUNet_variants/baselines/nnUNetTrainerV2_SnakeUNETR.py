...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.SnakeUNETR.snakeunetr import SnakeUNETR as SnakeUNETR_Orig
...
class SnakeUNETR(SnakeUNETR_Orig, SegmentationNetwork):
...
class nnUNetTrainerV2_SnakeUNETR(nnUNetTrainerV2_noDeepSupervision):
...
class nnUNetTrainerV2_SnakeUNETR_128x128x128(nnUNetTrainerV2_SnakeUNETR):
    ...
    def initialize_network(self):
        ...
        :return:
        """
        self.network = SnakeUNETR(img_size=(128, 128, 128),
...
class nnUNetTrainerV2_SnakeUNETR_128x128x128_lr_5e_4(nnUNetTrainerV2_SnakeUNETR):
...
class nnUNetTrainerV2_SnakeUNETR_128x128x128_Dummy(nnUNetTrainerV2_SnakeUNETR):
