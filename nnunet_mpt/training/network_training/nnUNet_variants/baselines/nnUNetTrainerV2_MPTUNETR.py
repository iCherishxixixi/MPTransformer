...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.MPTUNETR.mptunetr import MptUNETR as MptUNETR_Orig
...
class MptUNETR(MptUNETR_Orig, SegmentationNetwork):
...
class nnUNetTrainerV2_MptUNETR(nnUNetTrainerV2_noDeepSupervision):
...
class nnUNetTrainerV2_MptUNETR_128x128x128(nnUNetTrainerV2_MptUNETR):
    ...
    def initialize_network(self):
        ...
        :return:
        """
        self.network = MptUNETR(img_size=(128, 128, 128),
...
class nnUNetTrainerV2_MptUNETR_128x128x128_lr_5e_4(nnUNetTrainerV2_MptUNETR):
...
class nnUNetTrainerV2_MptUNETR_128x128x128_Dummy(nnUNetTrainerV2_MptUNETR):
