...
from nnunet_mpt.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from nnunet_mpt.training.loss_functions.dice_loss import DC_and_CE_loss
from nnunet_mpt.training.network_training.network_trainer import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(nnunet_mpt.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="nnunet_mpt.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in nnunet_mpt.preprocessing" % \
                                               preprocessor_name
