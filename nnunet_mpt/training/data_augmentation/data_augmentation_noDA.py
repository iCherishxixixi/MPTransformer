...
from nnunet_mpt.training.data_augmentation.custom_transforms import ConvertSegmentationToRegionsTransform
...
def get_patch_but_no_augmentation(dataloader_train, dataloader_val, patch_size,
    ...
    tr_transforms.append(SpatialTransform(
        ...
        border_cval_seg=0,
        order_seg=1, 
        random_crop=False, p_el_per_sample=params.get("p_eldef"),
