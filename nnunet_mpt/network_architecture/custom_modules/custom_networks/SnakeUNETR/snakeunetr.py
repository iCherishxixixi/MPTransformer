...
import sys
sys.path.append("../network_architecture/custom_modules/custom_networks/SnakeUNETR/")
from snakeconv import DCN_Conv, Snake_Embed
...
if __name__ == "__main__":
    ...
    network = SnakeUNETR(img_size=128, in_channels=1, out_channels=14, dummy=False).cuda()
