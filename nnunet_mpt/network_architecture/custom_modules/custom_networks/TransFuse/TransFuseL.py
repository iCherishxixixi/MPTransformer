...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransFuse.DeiT import deit_small_patch16_224 as deit
...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransFuse.models_vit import vit_large_patch16 as vit_large
...
class TransFuse_L(nn.Module):
    ...
    def forward(self, imgs, labels=None):
        # bottom-up path
        x_b = self.transformer(imgs) # torch.Size([16, 3, 224, 224]) ¡ú torch.Size([16, 196, 1024])
