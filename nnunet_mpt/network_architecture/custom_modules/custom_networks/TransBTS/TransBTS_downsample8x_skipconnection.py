...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransBTS.Transformer import TransformerModel
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransBTS.PositionalEncoding import FixedPositionalEncoding,LearnedPositionalEncoding
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransBTS.Unet_skipconnection import Unet
...
def TransBTS(dataset='brats', _conv_repr=True, _pe_type="learned",
    img_dim=128, num_classes=2, num_channels=4):
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        _, model = TransBTS(img_dim=128, num_classes=5, num_channels=2, 
                        _conv_repr=True, _pe_type="learned")
        model.cuda()
        y = model(x)
        print(y.shape)