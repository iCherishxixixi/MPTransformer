...
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransUnet import vit_seg_configs as configs
from nnunet_mpt.network_architecture.custom_modules.custom_networks.TransUnet.vit_seg_modeling_resnet_skip import ResNetV2
...
if __name__ == "__main__":
    ...
    model = TransUNet(config_vit,img_size=512, in_channels=3, dummy=True, num_classes=14)
