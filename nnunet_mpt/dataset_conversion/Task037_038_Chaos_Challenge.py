...
from nnunet_mpt.paths import preprocessing_output_dir, nnUNet_raw_data
from nnunet_mpt.utilities.sitk_stuff import copy_geometry
from nnunet_mpt.inference.ensemble_predictions import merge
...
def convert_variant2_predicted_test_to_submission_format(folder_with_predictions,
    ...
    from nnunet_mpt.postprocessing.connected_components import apply_postprocessing_to_folder, load_postprocessing
