...
### Quick Start
If you want to quickly use our embedding method, we provide ready-to-use 2D and 3D modules in the [`morphembeding`](morphembeding) folder. Here, DscPatchEmb directly generates the deformation field to produce deformable patches. MorphPatchEmb derives the deformation field from a velocity field before creating the patches.
### Data Preprocessing
